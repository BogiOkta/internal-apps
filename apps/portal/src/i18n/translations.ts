...
const englishTranslations = {
  ...
  "vacation.admin.description": "Review employee leave requests. This workspace is read-only.",
  ...
  "vacation.admin.detailsDescription": "Review the employee request and status history. No actions are available yet.",
...
const serbianLatinTranslations: TranslationDictionary = {
  ...
  "vacation.admin.description": "Pregledajte zahteve zaposlenih za odsustvo. Ovaj radni prostor je samo za čitanje.",
  "vacation.admin.filter.status": "Status",
  ...
  "vacation.admin.detailsDescription": "Pregledajte zahtev zaposlenog i istoriju statusa. Radnje još nisu dostupne.",
